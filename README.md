...
The dataset of my project for Chest X-Ray Image Classification (Pneumonia) was obtained from the [Kaggle - Chest X-Ray Dataset](https://www.kaggle.com/paultimothymooney/chest-xray-pneumonia).
